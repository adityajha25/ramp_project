  ...
  return (
    <div className="flex flex-col items-center gap-3 rounded-2xl border border-dashed border-gray-300 bg-gray-50 px-6 py-10 text-center">
      ...
      <textarea
        ...
        className="w-full max-w-md cursor-not-allowed resize-none rounded-xl border border-gray-200 bg-white px-3 py-2.5 text-sm text-gray-400 placeholder:text-gray-300"
      />
    </div>
  );
}
